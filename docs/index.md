...
<div class="quick-grid">
  ...
  <a href="#_9-完整案例"><div class="card-icon"><ClipboardList /></div><div class="card-body"><strong>完整案例</strong><span>按应用类型分类的部署方案</span></div></a>
...
错误码不知道属于哪一层时，看第 7 节开头的错误码索引表。AI 看到 `522` 容易直接去改 Worker 代码，但 `522` 其实是源站问题——喂上下文的时候顺手告诉它错误码归属哪层，能省一大段弯路。
