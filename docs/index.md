...
<div class="quick-grid">
  ...
  <a :href="withBase('/agents')"><div class="card-icon"><Bot /></div><div class="card-body"><strong>Cloudflare Agents</strong><span>不用服务器，跑一个长期在线的个人 AI 助手</span></div></a>
