...
| [官方 GitHub 仓库](https://github.com/cloudflare/cloudflare-docs) | 需要追踪文档修改历史时再查看，不作为日常阅读入口。 |
...
每次写文章时，按这个顺序核对来源：官方 `llms.txt`、产品级 Markdown、Pricing / Limits、线上文档，再按需查看官方仓库历史。
