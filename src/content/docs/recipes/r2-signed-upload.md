...
官方核对入口：[Use R2 from Workers](https://developers.cloudflare.com/r2/api/workers/workers-api-usage/)、[R2 presigned URLs](https://developers.cloudflare.com/r2/api/s3/presigned-urls/)、[R2 跨域配置](https://developers.cloudflare.com/r2/buckets/cors/)。
