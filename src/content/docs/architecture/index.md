...
| 模式 | 适合项目 | 核心产品 |
| --- | --- | --- |
| [静态内容站](/architecture/static-site/) | 文档站、官网、博客、作品集 | Workers Static Assets、Pages、Cache / CDN、Web Analytics |
| [API 网关](/architecture/api-gateway/) | 代理、鉴权、Webhook、轻量后端 | Workers、Service Bindings、D1、KV、Queues |
