...
| 已完成复核 | Billing 文案收敛 | 已把 [Billing](/platform/billing/) 收敛为账单三层模型、账单页四个入口、Workers Paid 位置、免费额度入口、usage-based 计量单位、成本信号、告警和取消降级清单；删除账号账单图、账单生命周期图、请求累计费用图、支付权限长表和过细付款说明。 |
...
| 已完成复核 | 免费额度首页再收敛 | 已把 [首页](/) 改成“先看免费额度”的强决策入口：保留免费额度大全，压缩重复组合表，按 Free 额度、5 USD/month Workers Paid 关系和撞墙信号组织内容；对齐 Workers Pricing / Limits、Static Assets、Pages、R2、Durable Objects、Workers AI、AI Search、Turnstile、WAF、Rate Limiting 和 Budget alerts。 |
...
| 已完成复核 | Rules 文案收敛 | 已把 [Rules](/platform/rules/) 收敛为普通项目选型、免费与计划边界、推荐顺序、Page Rules 迁移、Snippets / Workers 取舍、常见组合、升级信号和常见误区；保留 Rules overview、Redirects、Transform Rules、Configuration Rules、Origin Rules、Snippets、Cloud Connector、Compression Rules、Custom Errors、Trace 和 Page Rules migration 来源，删除流程图、执行顺序长说明、Ruleset Engine 概念、表达式字段、raw 字段、Trace / Log Explorer 深排查、IaC 管理段落和 Terraform / API 参考。 |
...
| 已完成复核 | Realtime 文案收敛 | 已把 [Realtime](/platform/realtime/) 收敛为文本实时与音视频实时的产品边界、免费/付费口径、RealtimeKit / SFU / TURN 的取舍和常见误区；删除实时能力图、SFU 架构图、RealtimeKit 概念表、SFU 限制长表、TURN 端口表和本站内部选择。 |
...
| 已完成复核 | 公共网络与专项服务文案收敛 | 已把 [公共网络与专项服务](/platform/public-network-specialties/) 收敛为专项能力判断、免费与付费边界、推荐顺序、产品边界和常见误区；保留 1.1.1.1、Radar、Time Services、Web3 limits、China Network、Google tag gateway 和 GitHub 源文件来源，删除 ASCII 分类图、本站当前选择、SDK / Terraform 扩展参考和过细产品拆解。 |
...
| 已完成复核 | 治理、合规与学习路径文案收敛 | 已把 [治理、合规与学习路径](/platform/governance-compliance-learning/) 收敛为普通项目治理取舍、免费与付费边界、推荐顺序、产品边界和常见误区；保留 Data Localization Suite、Client-side security、DMARC Management、Registrar、Support、Learning Paths、Use cases 和 GitHub 源文件来源，删除 ASCII 分类图、本站当前选择、过细 Support case 清单、Terraform / cf-terraforming 参考和冗余学习资料说明。 |
...
| 已完成复核 | 低频协议与平台工具文案收敛 | 已把 [低频协议与平台工具](/platform/edge-protocols-utilities/) 收敛为低频专项判断、免费与付费边界、Workers Paid 关系、推荐顺序和常见误区；保留 NEL、Randomness Beacon、Resource Tagging、Tenant、Version Management、Privacy Gateway / Proxy、MoQ、Agent Memory 和 GitHub 源文件来源，删除 ASCII 分类图、产品长篇拆解、API beta 细节、Version Management 兼容长表、Privacy Proxy 模型长表和过细 Agent Memory 限制说明。 |
...
| 已完成复核 | 开发者与网络补充专项文案收敛 | 已把 [开发者与网络补充专项](/platform/developer-network-additions/) 收敛为补充产品取舍、免费与付费边界、Workers Paid 关系、推荐顺序、产品边界和常见误区；保留 Agent Lee、Artifacts、Email Service、Flagship、Network、Network Flow、R2 SQL、Sandbox SDK、Style Guide 和 GitHub 来源，删除 ASCII 产品图、长篇产品拆解、Codex / Agent 写作流程、本站技术路线、Email / Flagship / Sandbox 过细实现说明。 |
...
| 已完成复核 | 免费额度首页三次强化 | 已把 [首页](/) 调整为“先看免费额度，不要先看产品名”的结构，第一屏放 0 元起步看板；首页大全表覆盖静态站、Workers、D1、KV、R2、Queues、Durable Objects、Zero Trust、AI、Realtime、SaaS、Images、Browser Run、Zaraz 和 Budget alerts；同步明确 [免费与付费边界](/platform/free-paid/) 是全站额度事实源。 |
...
| 已完成复核 | 本站技术栈二次精读 | 已把 [本站技术栈](/best-practices/site-stack/) 对齐 Starlight Site Search、Pagefind、Workers Static Assets、Static Assets billing、Workers pricing / limits、AI Search、Docs for agents、Twikoo / twikoo-cloudflare 和 GitHub 源仓库，补齐 Worker-first 架构、搜索路线、评论边界和免费额度影响。 |
| 已完成复核 | 最佳实践组文案收敛 | 已把 [最佳实践](/best-practices/)、[成本控制](/best-practices/cost/)、[安全边界](/best-practices/security/)、[本站技术栈](/best-practices/site-stack/) 和 [独立开发者推荐栈](/best-practices/indie-stack/) 收敛为免费额度优先、成熟组件优先、静态路径优先和升级信号优先；删除 ASCII 图、代码块、内部落地文件清单、当前仓库做法和过细实现说明。 |
...
| 已完成复核 | 入口与平台化文案收敛 | 已把 [学习路线](/start/)、[API 网关](/architecture/api-gateway/)、[平台化与多租户](/platform/platforms-saas/) 和 [开发者与网络补充专项](/platform/developer-network-additions/) 收敛为普通读者的阅读顺序、产品分工、启用前判断和常见误区；删除学习路线 ASCII 图、API 网关过细实现说明、平台化长篇运行模型和补充专项的过度技术拆解。 |
