...
- [D1 indexes best practice](https://developers.cloudflare.com/d1/best-practices/use-indexes/)
...
- [KV read cacheTtl](https://developers.cloudflare.com/kv/api/read-key-value-pairs/#cachettl-parameter)
...
- [Durable Objects WebSocket Hibernation](https://developers.cloudflare.com/durable-objects/best-practices/websockets/#websocket-hibernation)
...
- [AI Gateway Data Loss Prevention](https://developers.cloudflare.com/ai-gateway/features/dlp/)
...
- [AI Search UI snippets](https://developers.cloudflare.com/ai-search/configuration/retrieval/embed-search-snippets/)
...
- [Agents Think tools](https://developers.cloudflare.com/agents/harnesses/think/tools/)
...
- [GraphQL Analytics API Sampling](https://developers.cloudflare.com/analytics/graphql-api/sampling/)
...
- [Automatic SSL/TLS](https://developers.cloudflare.com/ssl/origin-configuration/ssl-modes/#automatic-ssltls-default)
...
- [Create WAF custom rules via API](https://developers.cloudflare.com/waf/custom-rules/create-api/)
...
- [Trace request limitations](https://developers.cloudflare.com/rules/trace-request/limitations/)
...
- [DDoS Protection Managed Rulesets](https://developers.cloudflare.com/ddos-protection/managed-rulesets/)
...
- [Fullstack applications reference architecture](https://developers.cloudflare.com/reference-architecture/diagrams/serverless/fullstack-application/)
- [Serverless global APIs](https://developers.cloudflare.com/reference-architecture/diagrams/serverless/serverless-global-apis/)
- [Durable Object control and data plane pattern](https://developers.cloudflare.com/reference-architecture/diagrams/storage/durable-object-control-data-plane-pattern/)
