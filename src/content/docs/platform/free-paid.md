...
| [cloudflare/cloudflare-docs Workers pricing source](https://github.com/cloudflare/cloudflare-docs/tree/production/src/content/docs/workers/platform) | Workers pricing / limits 源文件，适合核对 `$5 Workers Paid`、请求、CPU、Static Assets 文件限制。 |
