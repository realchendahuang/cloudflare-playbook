...
| 当前需求 | 推荐阅读 |
| --- | --- |
| 评估免费阶段适用范围 | [免费额度大全](/platform/free-paid/) |
| 接入域名和 HTTPS | [Fundamentals](/platform/fundamentals/)、[DNS](/platform/dns/)、[SSL/TLS](/platform/ssl-tls/) |
| 部署文档站、官网、博客 | [Workers Static Assets](/platform/static-assets/) 或 [Pages](/platform/pages/) |
| 构建接口、评论、表单、回调 | [Workers](/platform/workers/) |
| 处理数据库、缓存、文件、队列 | [数据能力](/platform/data/)、[D1](/platform/d1/)、[KV](/platform/kv/)、[R2](/platform/r2/) |
| 保护入口、后台和写接口 | [安全与网络](/platform/security-networking/) |
| 构建搜索或 AI 能力 | [AI 能力](/platform/ai/) |
| 查看访问、错误和成本 | [观测与日志](/platform/observability/)、[账单与预算](/platform/billing/) |
...
| 触发信号 | 推荐方案 |
| --- | --- |
| Worker 请求、CPU、日志、队列或数据能力接近 Free 限制 | Workers Paid。 |
| WAF、Bot、缓存规则、证书、域名级安全能力不足 | 更高域名计划。 |
