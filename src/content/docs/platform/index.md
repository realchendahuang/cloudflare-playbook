...
先从问题进入，再看产品。普通项目的主线是免费额度、静态内容、动态入口、数据、安全和账单；企业网络、平台化和长期日志放在后面。
...
| 写入口 | WAF 最小规则、限流、Turnstile | 自动化流量治理、更完整的接口防护、长期日志。 |
| 后台 | Access + Tunnel | 设备管控、长期日志、企业网络。 |
| 搜索 | Pagefind | AI Search、Vectorize、Workers AI。 |
| 观测 | Web Analytics、Workers Logs、预算提醒 | 长期日志、日志查询、外部日志平台。 |
