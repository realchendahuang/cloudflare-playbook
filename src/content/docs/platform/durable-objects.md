...
| 对象内数据读取 | 查询形状和索引决定成本，不要在对象里做全站报表。 |
...
额度数字回到 [免费额度大全](/platform/free-paid/) 核对。官方核对入口：[Durable Objects](https://developers.cloudflare.com/durable-objects/)、[Durable Objects Pricing](https://developers.cloudflare.com/durable-objects/platform/pricing/)、[Durable Objects Limits](https://developers.cloudflare.com/durable-objects/platform/limits/)。
