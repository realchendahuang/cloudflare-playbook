...
账单先分清四件事：哪些能免费跑，5 美元/月的 Workers Paid 买到什么，哪些付费和 Workers Paid 没关系，什么时候要看用量。
...
| 单独付费能力 | 负载均衡、智能路由、图片、视频、日志查询等 | 先确认固定费、按量费和真实需求。 |
| 按量计费 | Workers 超额用量、R2 操作、图片、视频、向量搜索、指标统计等 | 付费前先开预算提醒，再做限流、缓存和配额。 |
