...
官方核对入口：[Codex + Cloudflare](https://developers.cloudflare.com/agent-setup/codex/)、[Docs for Agents](https://developers.cloudflare.com/docs-for-agents/)、[Workers Best Practices](https://developers.cloudflare.com/workers/best-practices/workers-best-practices/)。
