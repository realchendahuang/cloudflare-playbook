...
Cloudflare 账单要分成 domain plan、Workers Paid、add-on 和 usage-based 四条线看。具体账单口径、Budget alerts、Billable Usage dashboard 和 invoice 规则见 [Billing](/platform/billing/)；完整数字见 [免费与付费边界](/platform/free-paid/)。
