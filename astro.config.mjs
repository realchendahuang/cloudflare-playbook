			...
			sidebar: [
					...
					items: [
						...
						},
						{
							...
							items: [
								...
								{ label: '公共网络能力', slug: 'platform/public-network-specialties' },
								{ label: '进阶协议与工具', slug: 'platform/edge-protocols-utilities' },
								{ label: '进阶开发者能力', slug: 'platform/developer-network-additions' },
							],
						},
						{
							label: '成本与治理',
				...
				},
				{
					...
					items: [
						...
						{ label: '接口入口', slug: 'architecture/api-gateway' },
				...
				},
				{
					...
					items: [
						...
						{ label: '文档站技术栈', slug: 'best-practices/site-stack' },
				...
				},
				{
					label: '实战案例',
					items: [
						{ label: 'GitHub 开源项目', slug: 'recipes' },
						{ label: 'Cloudflare 帖子合集', slug: 'recipes/cloudflare-posts' },
