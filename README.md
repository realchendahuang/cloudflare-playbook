...
| [数据产品](src/content/docs/platform/data.md) | D1、KV、R2、Queues、Durable Objects、Hyperdrive、AI Search 的数据形态选择。 |
...
| [AI 产品](src/content/docs/platform/ai.md) | Pagefind、AI Gateway、Workers AI、AI Search、Vectorize、Agents 的选择顺序。 |
